	...
	return (
		...
		>
			<div className="col-md-4 d-flex align-items-center">
				<span className="mb-3 mb-md-0 text-white font-bold">
					{new Date().getFullYear()} MONTES, DEV
				</span>
			</div>
			...
			<ul className="nav col-md-4 justify-content-end list-unstyled d-flex">
				<li className="ms-3">
					<a
						...
						href="https://api.whatsapp.com/send?phone=523325853823"
						target="_blank"
					>
						<svg
				...
				<li className="ms-3">
					<a
						className="text-body-secondary"
						href="www.linkedin.com/in/montes-32983b228"
						target="_blank"
					>
						<svg
							xmlns="http://www.w3.org/2000/svg"
				...
				<li className="ms-3">
					<a
						className="text-body-secondary"
						href="https://github.com/Onozayim"
						target="_blank"
					>
						<svg
							xmlns="http://www.w3.org/2000/svg"
