	...
	resources: {
		en: {
			translation: {
				...
				intro:
					"I've been working as a software developer for more than three years, focusing on the back-end area.",
		...
		es: {
			translation: {
				...
				intro:
					"Llevo trabajando como desarrollador de software por más de tres años, enfocándome en el área del back-end",
